/* ============================================================
   Projectile Motion — Exam question bank (22 past questions)
   Boards: MOE, IOM, BP, KU, IE, BPKIHS
   Sections: horizontal, angular, maxheight, energy, airres, incline
   ============================================================ */

const QUESTIONS = [
    {
        id: "q1", section: "airres", board: "BP", exam: "BP 2014",
    ...
    {
        id: "q2", section: "angular", board: "BP", exam: "BP 2010",
    ...
    {
        id: "q3", section: "angular", board: "MOE", exam: "MOE 2014",
    ...
    {
        id: "q4", section: "maxheight", board: "MOE", exam: "MOE 2012/11",
    ...
    {
        id: "q5", section: "energy", board: "MOE", exam: "MOE 2011",
    ...
    {
        id: "q6", section: "maxheight", board: "IOM", exam: "IOM 2013",
    ...
    {
        id: "q7", section: "energy", board: "MOE", exam: "MOE 2013",
    ...
    {
        id: "q8", section: "angular", board: "IOM", exam: "IOM 063",
    ...
    {
        id: "q9", section: "horizontal", board: "MOE", exam: "MOE 066",
    ...
    {
        id: "q10", section: "horizontal", board: "MOE", exam: "MOE 2065",
    ...
    {
        id: "q11", section: "energy", board: "MOE", exam: "MOE 2062",
    ...
    {
        id: "q12", section: "angular", board: "MOE", exam: "MOE 2000",
    ...
    {
        id: "q13", section: "angular", board: "MOE", exam: "MOE",
    ...
    {
        id: "q14", section: "angular", board: "IE", exam: "IE-02",
    ...
    {
        id: "q15", section: "energy", board: "IE", exam: "IE-05",
    ...
    {
        id: "q16", section: "horizontal", board: "IE", exam: "IE-07",
    ...
    {
        id: "q17", section: "maxheight", board: "BPKIHS", exam: "BPKIHS-09",
    ...
    {
        id: "q18", section: "angular", board: "BPKIHS", exam: "BPKIHS-07",
    ...
    {
        id: "q19", section: "incline", board: "BPKIHS", exam: "BPKIHS 02",
    ...
    {
        id: "q20", section: "horizontal", board: "KU", exam: "KU 2015",
    ...
    {
        id: "q21", section: "angular", board: "KU", exam: "KU 2017",
    ...
    {
        id: "q22", section: "horizontal", board: "IOM", exam: "IOM 2017",
